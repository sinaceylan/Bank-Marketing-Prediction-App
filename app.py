...
def main():
    ...
    duration = st.number_input('Enter Last Contact Duration', step=1)
    campaign = st.number_input('Enter Number of Contacts Performed', step=1)
    pdays = st.number_input('Enter Number of Days Passed After Last Contact', step=1)
    previous = st.number_input('Enter Number of Contacts Performed Before this Campaign', step=1)
